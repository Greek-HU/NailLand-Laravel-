...
class Prices extends Model
{
    ...
    {
        return $this->belongsToMany(EyeOpp::class, 'eyelashes_groupment', 'price_id', 'opp_id' );
    }

    public function EyeTypes() : BelongsToMany
    {
        return $this->belongsToMany(EyeTypes::class, 'eyelashes_groupment', 'price_id', 'type_id' );
